...
filename <- "/home/sys4ppl/answer.R"
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R을 이용한 통계 분석](https://kilhwan.github.io/bizstat-book/ch-dataTransformation.html#sec:filter))
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R을 이용한 통계 분석](https://kilhwan.github.io/bizstat-book/ch-dataTransformation.html#sec:arrange))
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R을 이용한 통계 분석](https://kilhwan.github.io/bizstat-book/ch-dataTransformation.html#sec:select))
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R을 이용한 통계 분석](https://kilhwan.github.io/bizstat-book/ch-dataTransformation.html#sec:mutate))
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R을 이용한 통계 분석](https://kilhwan.github.io/bizstat-book/ch-dataTransformation.html#sec:summarize))
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R을 이용한 통계 분석](https://kilhwan.github.io/bizstat-book/ch-dataTransformation.html#sec:pipeOperator))
