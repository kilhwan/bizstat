...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R 프로그래밍](https://kilhwan.github.io/rprogramming/chap-visulaize.html#sec:getStarted-ggplot2))
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R 프로그래밍](https://kilhwan.github.io/rprogramming/chap-visulaize.html#sec:facets))
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R 프로그래밍](https://kilhwan.github.io/rprogramming/chap-visulaize.html#sec:layerAndGeom))
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R 프로그래밍](https://kilhwan.github.io/rprogramming/chap-visulaize.html#sec:ggplotStat))
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R 프로그래밍](https://kilhwan.github.io/rprogramming/chap-visulaize.html#sec:position))
