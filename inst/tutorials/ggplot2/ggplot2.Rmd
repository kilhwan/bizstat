...
library(tidyverse)
library(bizstatp)
knitr::opts_chunk$set(echo = FALSE, exercise.checker = function(
    label,
    user_code,
    solution_code,
    check_code,
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R을 이용한 통계 분석](https://kilhwan.github.io/bizstat-book/chap-visulaize.html#sec:getStarted-ggplot2))
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R을 이용한 통계 분석](https://kilhwan.github.io/bizstat-book/chap-visulaize.html#%EB%8F%84%ED%98%95%EC%9D%98-%EC%86%8D%EC%84%B1%EC%97%90-%EB%8C%80%EC%9D%91%EC%8B%9C%ED%82%A4%EA%B8%B0-vs.%EB%8F%84%ED%98%95%EC%9D%98-%EC%86%8D%EC%84%B1-%EC%9D%B8%EC%88%98%EB%A5%BC-%EC%84%A4%EC%A0%95%ED%95%98%EA%B8%B0))
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R을 이용한 통계 분석](https://kilhwan.github.io/bizstat-book/chap-visulaize.html#sec:facets))
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R을 이용한 통계 분석](https://kilhwan.github.io/bizstat-book/chap-visulaize.html#sec:layerAndGeom))
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R을 이용한 통계 분석](https://kilhwan.github.io/bizstat-book/chap-visulaize.html#sec:ggplotStat))
...
`course` 데이터를 이용하여 다음 문제를 풀어보시오. (참고자료: [R을 이용한 통계 분석](https://kilhwan.github.io/bizstat-book/chap-visulaize.html#sec:position))
